...
def get_split_modify_file_path(modified_files, module_name, module_path):
    ...
    for i in range(len(modified_files)):
        ...
        new_path_parts = path_parts[module_path_len:]
        new_path = os.path.join(module_name, *new_path_parts)
