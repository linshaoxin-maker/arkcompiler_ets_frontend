...
def generate_report_html(summary_data, detail_data):
    ...
    daily_report_file = options.configs['output_file_paths']['output_html_file']
...
def generate_log_file():
    ...
    output_log_file = options.configs['output_file_paths']['log_file']
...
def add_folder_to_zip(folder_path, output_zip):
...
def process_test_result(test_tasks, start_time):
    ...
    add_folder_to_zip(options.configs[''], 'pictures.zip')
