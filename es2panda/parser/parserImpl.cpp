...
ir::TSUnionType *ParserImpl::ParseTsUnionType(ir::Expression *type, bool restrictExtends, bool throwError)
{
    ...
    while (true) {
        ...
        ir::Expression* union_suffix_type = ParseTsTypeAnnotation(&options);
        if (union_suffix_type == nullptr) {
            return nullptr;
        }

        types.push_back(union_suffix_type);
    }
                                                            ...
                                                            bool throwError)
{
    ...
    while (true) {
        ...
        ir::Expression* suffix_type = ParseTsTypeAnnotation(&options);
        if (suffix_type == nullptr) {
            return nullptr;
        }
        types.push_back(suffix_type);
    }
