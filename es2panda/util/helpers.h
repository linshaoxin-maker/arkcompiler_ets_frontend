...
struct DepsRelationInfo {
    ...
    DepsRelationInfo(const std::map<std::string, std::unordered_set<std::string>> resolveDepsRelation,
        const std::unordered_set<std::string> generatedRecords)
    : resolveDepsRelation(resolveDepsRelation), generatedRecords(generatedRecords) {};
};
...
public:
    ...
    static bool BelongToRetainRecord(const std::string &name, const std::unordered_set<std::string> &retainRecordSet,
