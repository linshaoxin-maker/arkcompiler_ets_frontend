...
export class PandaGen {
    ...
    prepareHandleMode(node: ts.Node, asyncGen: VReg){
        this.add(node, new EcmaPreparehandlemode(asyncGen));
    }
    ...
    EcmaAsyncgeneratorresolve(node: ts.Node, genObj: VReg, value: VReg) {
