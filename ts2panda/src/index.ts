...
function ts2abcTransform(node: ts.SourceFile,
    ...
    let name: string = sourceFileName.substring(0, sourceFileName.lastIndexOf("."));
    let recoder: Record = new Record(name, sourceFileName);
    ...
    let compilerDriver = new CompilerDriver(newOutputFileName, ts2abcProc, sourceFileName);
