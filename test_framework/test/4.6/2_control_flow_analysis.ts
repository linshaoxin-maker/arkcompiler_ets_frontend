...
Assert.equal(2, processAction(action1));
Assert.equal("1234", processAction(action2));
...
function processAction2(action: Action2) {
...
Assert.equal(4, processAction2(action3));
Assert.equal("5678", processAction2(action4));