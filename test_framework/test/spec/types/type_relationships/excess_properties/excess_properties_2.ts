...
var address: InputElement = {
  name: "Address",
  visible: true,
  // Allowed because of index signature  
  help: "Enter address here",
  // Allowed because of index signature  
  shortcut: "Alt-A"
};
Assert.equal(JSON.stringify(address), '{"name":"Address","visible":true,"help":"Enter address here","shortcut":"Alt-A"}')