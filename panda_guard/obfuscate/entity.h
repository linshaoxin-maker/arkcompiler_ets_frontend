...
namespace panda::guard {
    ...
    protected:
        ...
        /**
         * 写入混淆映射关系到NameCache文件中被混淆文件的IdentifierCache和MemberMethodCache节点下
         * @param filePath 混淆前文件名
         */
        virtual void WriteFileCache(const std::string &filePath);

        /**
         * 写入混淆映射关系到NameCache文件中PropertyCache节点下
         */
