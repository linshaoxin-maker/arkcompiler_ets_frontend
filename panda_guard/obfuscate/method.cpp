...
void panda::guard::OuterMethod::RefreshNeedUpdate()
{
    ...
    LOG(INFO, PANDAGUARD) << TAG << "Refresh outerMethod contentNeedUpdate: "
                          << (this->contentNeedUpdate_ ? "true" : "false");
    LOG(INFO, PANDAGUARD) << TAG << "Refresh outerMethod nameNeedUpdate: "
                          << (this->nameNeedUpdate_ ? "true" : "false");
}
...
void panda::guard::OuterMethod::SetContentNeedUpdate(bool toUpdate)
{
    ...
    LOG(INFO, PANDAGUARD) << TAG << "Set outerMethod contentNeedUpdate: "
                          << (this->contentNeedUpdate_ ? "true" : "false");
