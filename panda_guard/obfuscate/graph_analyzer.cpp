...
namespace {
    ...
    const InstIdFilterList INST_ID_LIST_STLEXVAR = {
        IntrinsicId::STLEXVAR_IMM4_IMM4,
        IntrinsicId::STLEXVAR_IMM8_IMM8
    };
    ...
    const std::map<panda::pandasm::Opcode, InstParam> LDA_STA_INST_PARAM_MAP = {
        ...
        {
            panda::pandasm::Opcode::STLEXVAR,
            {0, INST_ID_LIST_STLEXVAR}
        },
        {
