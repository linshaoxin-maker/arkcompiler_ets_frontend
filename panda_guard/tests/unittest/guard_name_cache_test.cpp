...
HWTEST(GuardNameCacheUnitTest, guard_name_cache_test_001, TestSize.Level4)
{
    ...
    std::set<std::string> expectList = {
        "/entry/src/a/b.ets", "5.0.0.1", "a", "b", "c", "d", "e", "entry|1.0.0", "f", "g"
    };
...
HWTEST(GuardNameCacheUnitTest, guard_name_cache_test_002, TestSize.Level4)
{
    ...
    std::set<std::string> expectList = {
        "/entry/src/a/b.ets", "/entry/src/a2/b2.ets", "5.0.0.2", "a", "a1", "a2", "b", "b1", "b2", "c", "c2", "d",
        "d2", "e", "entry|2.0.1", "f", "g"
    };
