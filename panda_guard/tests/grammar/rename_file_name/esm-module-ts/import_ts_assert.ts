...
import {value01, generatorFunctionName01} from "./folder//export_declarations";
...
import {var1, var2 as alias2} from ".\\export_list";

print(var1 === 1, 'success');
print(alias2 === 2, 'success');

// import indirect module
import {value05, bar} from './indirect_export'

print(value05 === 11, 'success');
print(bar === 'jack', 'success');
