...
bool Options::Parse(int argc, const char **argv)
{
    ...
    panda::PandArg<bool> dumpSizeStat("dump-size-stat", false, "display size statistics of the merged abc file");
