...
declare class ConfigManager implements Config {
   ...
   * @param configName The name of the configuration
   * @param isActive A boolean indicating if the configuration is active
   */
...
declare namespace AppUtilities {
  /** A string constant inside the namespace */
...
/** 
 * Module declaration containing exported functions.
 */
