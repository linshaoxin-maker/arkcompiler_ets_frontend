...
class MyException(Exception):  # Inherited exception class
...
def parse_args():
    ...
    parser.add_argument('--ark_frontend_tool',
...
# Using machine translation (path: ts file path, out_file: output content is written to the file path, tools, tool selection, the default is' ohos - arm - release/clang_x64 / ano ano/build/SRC/index, js')
