...
class SendableImpl implements ISendable {} // OK, class is now sendable

class BadInterfaceImpl extends SendableImpl {} // ERROR, no @Sendable decorator

@Sendable
class GoodInterfaceImpl extends SendableImpl {} // OK
