...
exports.scopeContainsThis = scopeContainsThis;
...
function scopeContainsThisVisitor(tsNode) {
...
function scopeContainsThis(tsNode) {
  return scopeContainsThisVisitor(tsNode);
}
//# sourceMappingURL=ContainsThis.js.map