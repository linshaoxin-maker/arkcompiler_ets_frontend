...
const fs = require('fs');
const linter = require('./linterLib/linter_1_1/RunArkTSLinter');
const TypeScriptLinter_1 = require("./lib/TypeScriptLinter");
const InteropTypescriptLinter_1 = require("./lib/InteropTypescriptLinter");
const Logger = require('./lib/Logger');
const LoggerImpl = require('./src/LoggerImpl');
Logger.Logger.init(new LoggerImpl.LoggerImpl());
...
TypeScriptLinter_1.TypeScriptLinter.ideMode = true;
// TypeScriptLinter_1.TypeScriptLinter.testMode = true;
InteropTypescriptLinter_1.InteropTypescriptLinter.ideMode = true;
// InteropTypescriptLinter_1.InteropTypescriptLinter.testMode = true;
...
function runLinter(rootName) {
  ...
  let result = linter.runArkTSLinter(builderProgram);
  return result;
}
