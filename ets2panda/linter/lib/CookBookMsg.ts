...
cookBookTag[154] = 'Properties in "Sendable" classes must have a Sendable data type (arkts-sendable-prop-types)';
...
cookBookTag[160] = 'Computed property names are not allowed in "Sendable" classes (arkts-sendable-computed-prop-name)';
