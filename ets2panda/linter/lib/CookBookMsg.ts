...
cookBookTag[156] = 'Only "Sendable" data types are allowed as type arguments of generic "Sendable" type (arkts-sendable-generic-types)';
cookBookTag[157] = 'Non-sendable data can not be cast to "Sendable" data (arkts-sendable-as-expr)';
cookBookTag[158] = 'No decorators can be used in a sendable class and only `@Sendable` can be used on a sendable class declaration (arkts-sendable-class-decorator)';
