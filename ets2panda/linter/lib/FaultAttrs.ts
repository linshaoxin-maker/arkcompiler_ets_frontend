...
faultsAttrs[FaultID.ThisTyping] = new FaultAttributes(21);
...
faultsAttrs[FaultID.SendableToolsLimited] = new FaultAttributes(181, ProblemSeverity.WARNING);
faultsAttrs[FaultID.SendableGenericTypesWarning] = new FaultAttributes(156, ProblemSeverity.WARNING);
faultsAttrs[FaultID.SharedModuleExportsWarning] = new FaultAttributes(163, ProblemSeverity.WARNING);
faultsAttrs[FaultID.SendableCapturedVarsWarning] = new FaultAttributes(157, ProblemSeverity.WARNING);
faultsAttrs[FaultID.SendableFunctionImportedVariablesWarning] = new FaultAttributes(172, ProblemSeverity.WARNING);
