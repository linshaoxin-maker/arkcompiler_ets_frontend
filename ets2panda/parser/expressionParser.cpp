    ...
    ir::TSTypeParameterDeclaration *type_param_decl, ir::TypeNode *return_type_annotation)
{
    ...
    func_node = AllocNode<ir::ScriptFunction>(Allocator(), function_scope, std::move(desc->params), type_param_decl,
                                              body, return_type_annotation, arrow_function_context->Flags(), false,
                                              context_.GetLanguge());
