...
#ifndef ES2PANDA_PARSER_THROWABLED_TYPED_PARSER_H
#define ES2PANDA_PARSER_THROWABLED_TYPED_PARSER_H
...
class ThrowableTypedParser : public TypedParser {
public:
...
#endif  // ES2PANDA_PARSER_THROWABLED_TYPED_PARSER_H
