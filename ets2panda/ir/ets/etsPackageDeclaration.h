...
#ifndef ES2PANDA_IR_ETS_PACKAGE_DECLARATION_H
#define ES2PANDA_IR_ETS_PACKAGE_DECLARATION_H
...
public:
    ...
    [[nodiscard]] ETSPackageDeclaration *Clone(ArenaAllocator *allocator, AstNode *parent) override;
