...
public:
    ...
    bool IsCompatibleTypeArgument(ETSTypeParameter *type_param, Type *type_argument, const Substitution *substitution);
    ...
    static void EmplaceSubstituted(Substitution *substitution, ETSTypeParameter *tparam, Type *type_arg);
    ...
    ArenaVector<Type *> CreateTypeForTypeParameters(ir::TSTypeParameterDeclaration const *type_params);
    [[nodiscard]] bool EnhanceSubstitutionForType(const ArenaVector<Type *> &type_params, Type *param_type,
                                                  Type *argument_type, Substitution *substitution,
                                                  ArenaUnorderedSet<ETSTypeParameter *> *instantiated_type_params);
    [[nodiscard]] bool EnhanceSubstitutionForObject(const ArenaVector<Type *> &type_params, ETSObjectType *param_type,
                                                    Type *argument_type, Substitution *substitution,
                                                    ArenaUnorderedSet<ETSTypeParameter *> *instantiated_type_params);
    ...
    void CheckNumberOfTypeArguments(ETSObjectType *type, ir::TSTypeParameterInstantiation *type_args,
                                    const lexer::SourcePosition &pos);
...
private:
    ...
    void ValidateGetterSetter(const ir::MemberExpression *member_expr, const varbinder::LocalVariable *prop,
                              PropertySearchFlags search_flag);
    void ValidateVarDeclaratorOrClassProperty(const ir::MemberExpression *member_expr, varbinder::LocalVariable *prop);
    std::tuple<bool, bool> IsResolvedAndValue(const ir::Expression *expr, Type *type) const;
    PropertySearchFlags GetSearchFlags(const ir::MemberExpression *member_expr, const varbinder::Variable *target_ref);
    PropertySearchFlags GetInitialSearchFlags(const ir::MemberExpression *member_expr);
