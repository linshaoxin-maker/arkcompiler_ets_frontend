...
public:
    ...
    ETSFunctionType *CreateETSFunctionType(ir::ScriptFunction *func, ArenaVector<Signature *> &&signatures,
                                           util::StringView const &name);
    ...
    Type *ResolveFunctionalInterfaces(ArenaVector<Signature *> const &signatures);
