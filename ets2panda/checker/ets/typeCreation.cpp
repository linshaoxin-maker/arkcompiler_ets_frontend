...
std::map<util::StringView, GlobalTypeId> name_to_type_id = {
...
std::map<util::StringView, std::function<ETSObjectType *(const ETSChecker *)>> name_to_global_type = {
...
std::map<util::StringView, std::function<Type *(const ETSChecker *)>> name_to_global_box_type = {
