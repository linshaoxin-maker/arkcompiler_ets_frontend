...
#ifndef ES2PANDA_COMPILER_CHECKER_TYPES_ETS_BYTE_TYPE_H
...
public:
    ...
    ByteType() : Type(TypeFlag::BYTE) {}
    explicit ByteType(UType value) : Type(TypeFlag::BYTE | TypeFlag::CONSTANT), value_(value) {}
    ...
    {
        ss << (IsConstantType() ? std::to_string(value_) : "byte");
    }
    ...
    {
        ss << compiler::Signatures::TYPE_DESCRIPTOR_BYTE;
    }
