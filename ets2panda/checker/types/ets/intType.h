...
#ifndef ES2PANDA_COMPILER_CHECKER_TYPES_ETS_INT_TYPE_H
...
public:
    ...
    IntType() : Type(TypeFlag::INT) {}
    explicit IntType(UType value) : Type(TypeFlag::INT | TypeFlag::CONSTANT), value_(value) {}
    ...
    {
        ss << (IsConstantType() ? std::to_string(value_) : "int");
    }
