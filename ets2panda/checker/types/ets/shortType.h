...
#ifndef ES2PANDA_COMPILER_CHECKER_TYPES_ETS_SHORT_TYPE_H
#define ES2PANDA_COMPILER_CHECKER_TYPES_ETS_SHORT_TYPE_H
...
public:
    ...
    ShortType() : Type(TypeFlag::SHORT) {}
    explicit ShortType(UType value) : Type(TypeFlag::SHORT | TypeFlag::CONSTANT), value_(value) {}
    ...
    {
        ss << compiler::Signatures::PRIMITIVE_SHORT;
    }

    void ToDebugInfoType(std::stringstream &ss) const override
    {
        ss << compiler::Signatures::TYPE_DESCRIPTOR_SHORT;
    }
