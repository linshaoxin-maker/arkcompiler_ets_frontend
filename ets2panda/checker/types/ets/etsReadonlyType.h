...
#ifndef ES2PANDA_COMPILER_CHECKER_TYPES_ETS_READONLY_TYPE_H
...
class ETSReadonlyType : public Type {
public:
    explicit ETSReadonlyType(ETSTypeParameter *tparam) : Type(TypeFlag::ETS_READONLY), tparam_(tparam) {}
