...
cookBookTag[115] = '';
cookBookTag[116] = 'Non-declaration statements in namespaces are not supported (single semicolons are considered as empty non-declaration statement) (arkts-no-ns-statements)';
cookBookTag[117] = '';
