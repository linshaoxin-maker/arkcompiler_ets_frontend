...
class PhaseForDeclarations : public Phase {
    bool Precondition(public_lib::Context *ctx, const parser::Program *program);
    bool Perform(public_lib::Context *ctx, parser::Program *program);
    bool Postcondition(public_lib::Context *ctx, const parser::Program *program);

    /* Called from Perform, Prre/Postcondition */
