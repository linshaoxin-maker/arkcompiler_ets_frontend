...
ir::MethodDefinition *GlobalClassHandler::CreateInitMethod()
{
    ...
    auto methodDef = NodeAllocator::Alloc<ir::MethodDefinition>(allocator_, ir::MethodDefinitionKind::METHOD, initIdent,
                                                      ...
                                                      const lexer::SourcePosition &loc, bool allowEmptyCctor)
{
    ...
    auto *func = NodeAllocator::Alloc<ir::ScriptFunction>(
        ...
        ir::ScriptFunctionFlags::STATIC_BLOCK | ir::ScriptFunctionFlags::HIDDEN, ir::ModifierFlags::STATIC, false,
