...
int main(int argc, char **argv)
{
    ...
    auto funcExpr = const_cast<es2panda_AstNode *>(impl->FunctionDeclarationFunctionConst(context, statements[0]));
    auto expressionStatement =
        impl->BlockStatementStatements(context, impl->ScriptFunctionBody(context, funcExpr), &n)[0];
    auto binExpr = impl->AssertStatementTest(context, expressionStatement);
