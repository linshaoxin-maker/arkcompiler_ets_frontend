...
using panda::es2panda::compiler::ast_verifier::ASTVerifier;
using panda::es2panda::compiler::ast_verifier::InvariantNameSet;
...
{
    panda::es2panda::compiler::ast_verifier::ASTVerifier verifier {Allocator()};
    StringLiteral emptyNode;

    const auto check = "NodeHasParent";
    auto checks = panda::es2panda::compiler::ast_verifier::InvariantNameSet {};
    checks.insert(check);
