...
TEST_F(RestParameterTest, function_without_rest_parameters_0)
{
    ...
    CheckNoRestParameterFlag("ETSGLOBAL.fn:std.core.void;");
}
...
TEST_F(RestParameterTest, function_without_rest_parameters_1)
{
    ...
    CheckNoRestParameterFlag("ETSGLOBAL.fn:i32[];std.core.void;");
}
...
TEST_F(RestParameterTest, function_without_rest_parameters_2)
{
    ...
    CheckNoRestParameterFlag("ETSGLOBAL.fn:i32;std.core.String[];std.core.void;");
}
...
TEST_F(RestParameterTest, function_with_rest_parameter_0)
{
    ...
    CheckRestParameterFlag("ETSGLOBAL.fn:std.core.String[];std.core.void;");
}
...
TEST_F(RestParameterTest, function_with_rest_parameter_1)
{
    ...
    CheckRestParameterFlag("ETSGLOBAL.fn:std.core.Object;i32[];std.core.void;");
}
...
TEST_F(RestParameterTest, class_method_without_rest_parameters_0)
{
    ...
    CheckNoRestParameterFlag("A.fn:std.core.void;");
}
...
TEST_F(RestParameterTest, class_method_without_rest_parameters_1)
{
    ...
    CheckNoRestParameterFlag("A.fn:i32;std.core.void;");
}
...
TEST_F(RestParameterTest, class_method_with_rest_parameters_0)
{
    ...
    CheckRestParameterFlag("A.fn:i32[];std.core.void;");
}
...
TEST_F(RestParameterTest, static_class_method_with_rest_parameters_1)
{
    ...
    CheckRestParameterFlag("A.fn:std.core.String[];i32[];std.core.void;");
}
...
TEST_F(RestParameterTest, interface_without_rest_parameters_1)
{
    ...
    CheckNoRestParameterFlag("A.fn:std.core.String[];std.core.void;");
}
...
TEST_F(RestParameterTest, interface_with_rest_parameters_0)
{
    ...
    CheckRestParameterFlag("A.fn:std.core.Object[];std.core.void;");
}
...
TEST_F(RestParameterTest, interface_with_rest_parameters_1)
{
    ...
    CheckRestParameterFlag("A.fn:std.core.Object;std.core.String[];std.core.void;");
}
...
TEST_F(RestParameterTest, lambda_without_rest_parameters_0)
{
    ...
    CheckNoRestParameterFlag("FunctionalInterface-i32-0.invoke:i32;");
}
...
TEST_F(RestParameterTest, lambda_without_rest_parameters_1)
{
    ...
    CheckNoRestParameterFlag("FunctionalInterface-i64[]-i32-0.invoke:i64[];i32;");
}
...
TEST_F(RestParameterTest, abstract_function_with_rest_parameter_0)
{
    ...
    CheckRestParameterFlag("A.fn:std.core.String[];std.core.void;");
}
...
TEST_F(RestParameterTest, abstract_function_with_rest_parameter_1)
{
    ...
    CheckRestParameterFlag("A.fn:i32;std.core.String[];std.core.void;");
}
...
TEST_F(RestParameterTest, external_function_with_rest_parameter_2)
{
    SetCurrentProgram(R"(
    )");
    CheckRestParameterFlag("escompat.Math.min:f64[];f64;");
}
