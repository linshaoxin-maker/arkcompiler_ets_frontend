...
public:
    ...
    explicit UString(const std::string_view &str, ArenaAllocator *allocator) : UString(allocator)
    {
        Alloc();
        *str_ = str;
    }

    explicit UString(const util::StringView &str, ArenaAllocator *allocator) : UString(str.Utf8(), allocator) {}
