...
bool Options::Parse(int argc, const char **argv)
{
    ...
    panda::PandArg<std::string> verifierErrors(
        ...
        "EveryChildHasValidParentForAll,ArithmeticOperationValidForAll",
